...
public class TaskManager {
    ...
    public TaskManager(ApartmentCorei3 plugin, ApartmentManager apartmentManager, ConfigManager configManager, AuctionManager auctionManager) {
        this.plugin = plugin;
        this.apartmentManager = apartmentManager;
        this.configManager = configManager;
        ...
        new BukkitRunnable() {
            ...
            public void run() {
                ...
                if (currentDay > lastMinecraftDay) {
                    ...
                    // Saving is now handled by the auto-save task
                }
            }
    ...
    private void startAutoSaveTask() {
        ...
        new BukkitRunnable() {
            private int runs = 0;
            private final int backupFrequency = 6; // Run backup every 6th save (e.g., every 60 mins if save is 10 mins)
