...
public class ApartmentManager {
    ...
    /**
     * Process daily taxes for all apartments
     */
    public void processDailyTaxes(long daysPassed) {
        for (Apartment apt : apartments.values()) {
            if (apt.owner != null) {
                apt.processDailyTax(economy, daysPassed, plugin, configManager, apartmentRatings);
            }
        }
        saveApartments();
    }
